...
public class white_gazipur extends AppCompatActivity {
    private Button ok1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_gazipur);
            ...
            public void onClick(View v) {
                if(((!checkBox1.isChecked()  && Integer.parseInt(textView1.getText().toString())>0)) || ((!checkBox2.isChecked()  && Integer.parseInt(textView2.getText().toString())>0)) || ((!checkBox3.isChecked()  && Integer.parseInt(textView3.getText().toString())>0)) || ((!checkBox4.isChecked()  && Integer.parseInt(textView4.getText().toString())>0))){
                    ...
                    if(checkBox1.isChecked()){
                        int singleBedRent =1587 * (Integer.parseInt(textView1.getText().toString()));
                    ...
                    if(checkBox3.isChecked()){
                        int twinRoomRent =2780 * (Integer.parseInt(textView3.getText().toString()));
                    ...
                    Intent intent_3= new Intent(white_gazipur.this,select_car.class);
    ...
    public void cheackRoom(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(white_gazipur.this).create();
