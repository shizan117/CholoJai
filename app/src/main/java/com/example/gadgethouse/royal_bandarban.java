...
public class royal_bandarban extends AppCompatActivity {
    private Button ok1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royal_bandarban);
            ...
            public void onClick(View v) {
                if(((!checkBox1.isChecked()  && Integer.parseInt(textView1.getText().toString())>0)) || ((!checkBox2.isChecked()  && Integer.parseInt(textView2.getText().toString())>0)) || ((!checkBox3.isChecked()  && Integer.parseInt(textView3.getText().toString())>0)) || ((!checkBox4.isChecked()  && Integer.parseInt(textView4.getText().toString())>0))){
                    ...
                    if(checkBox1.isChecked()){
                        int singleBedRent =3176 * (Integer.parseInt(textView1.getText().toString()));
                        hotelCost=hotelCost+singleBedRent;
                    }
                    if(checkBox2.isChecked()){
                        int doubleBedRent =4990 * (Integer.parseInt(textView2.getText().toString()));
                        hotelCost=hotelCost+doubleBedRent;
                    }
                    if(checkBox3.isChecked()){
                        int twinRoomRent =4680 * (Integer.parseInt(textView3.getText().toString()));
                        hotelCost=hotelCost+twinRoomRent;
                    }
                    if(checkBox4.isChecked()){
                        int presidentialRent =6650 * (Integer.parseInt(textView4.getText().toString()));
                        hotelCost=hotelCost+presidentialRent;
                    }

                    Intent intent_3= new Intent(royal_bandarban.this,select_car.class);
    ...
    public void cheackRoom(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(royal_bandarban.this).create();
