...
public class tangail_hotel extends AppCompatActivity {
    private LinearLayout checkInDate,checkOutDate,jomunaLayout,elengaLayout,prince_tangaiLayout,hotelxLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tangail_hotel);

        email = getIntent().getStringExtra("email");
        numberOfSpot = getIntent().getIntExtra("numberOfSpot",0);
        location = getIntent().getStringExtra("location");

        jomunaLayout = (LinearLayout) findViewById(R.id.jomunaLayout);
        jomunaLayout.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(tangail_hotel.this,jomuna_tangail.class);
        ...
        elengaLayout = (LinearLayout) findViewById(R.id.elengaLayout);
        elengaLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(tangail_hotel.this,elenga_tangail.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        prince_tangaiLayout = (LinearLayout) findViewById(R.id.prince_tangailLayout);
        prince_tangaiLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(tangail_hotel.this,prince_tangail.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        hotelxLayout = (LinearLayout) findViewById(R.id.hotelxLayout);
        hotelxLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(tangail_hotel.this,hotelx_tangail.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        showLocation2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Elenga Resort Ltd");
            }
        });
        ...
        showLocation4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Hotel X");
            }
        });
    }

    public void fillUpTheDate(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(tangail_hotel.this).create();
    ...
    private void showLocation(String sDestination) {
        String sSource = "Tangail New Bus Terminal";
        try{
