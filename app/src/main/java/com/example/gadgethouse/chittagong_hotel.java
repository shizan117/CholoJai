...
public class chittagong_hotel extends AppCompatActivity {
    private LinearLayout checkInDate,checkOutDate,radissonLayout,wellLayout,goldenLayout,oceanLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chittagong_hotel);

        email = getIntent().getStringExtra("email");
        numberOfSpot = getIntent().getIntExtra("numberOfSpot",0);
        location = getIntent().getStringExtra("location");

        radissonLayout = (LinearLayout) findViewById(R.id.radissonLayout);
        radissonLayout.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(chittagong_hotel.this,radissonblue_chittagong.class);
        ...
        wellLayout = (LinearLayout) findViewById(R.id.wellLayout);
        wellLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(chittagong_hotel.this,wellpark_chittagong.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        goldenLayout = (LinearLayout) findViewById(R.id.goldenLayout);
        goldenLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(chittagong_hotel.this,golden_chittagong.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        oceanLayout = (LinearLayout) findViewById(R.id.oceanLayout);
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(chittagong_hotel.this,ocean_chittagong.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        showLocation1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Radisson Blu Chattogram Bay");
            }
        });
        ...
        showLocation2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Well Park Residence Boutique");
            }
        });
    ...
    public void fillUpTheDate(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(chittagong_hotel.this).create();
    ...
    private void showLocation(String sDestination) {
        String sSource = "Bahdderhat Bus Terminal";
        try{
