...
public class peninsula_bandarban extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peninsula_bandarban);
            ...
            public void onClick(View v) {
                if(((!checkBox1.isChecked()  && Integer.parseInt(textView1.getText().toString())>0)) || ((!checkBox2.isChecked()  && Integer.parseInt(textView2.getText().toString())>0)) || ((!checkBox3.isChecked()  && Integer.parseInt(textView3.getText().toString())>0)) || ((!checkBox4.isChecked()  && Integer.parseInt(textView4.getText().toString())>0))){
                    ...
                    if(checkBox1.isChecked()){
                        int singleBedRent =5218 * (Integer.parseInt(textView1.getText().toString()));
                        hotelCost=hotelCost+singleBedRent;
                    }
                    if(checkBox2.isChecked()){
                        int doubleBedRent =7442 * (Integer.parseInt(textView2.getText().toString()));
                        hotelCost=hotelCost+doubleBedRent;
                    }
                    if(checkBox3.isChecked()){
                        int twinRoomRent =7342 * (Integer.parseInt(textView3.getText().toString()));
                        hotelCost=hotelCost+twinRoomRent;
                    }
                    if(checkBox4.isChecked()){
                        int presidentialRent =9750 * (Integer.parseInt(textView4.getText().toString()));
                        hotelCost=hotelCost+presidentialRent;
                    }

                    Intent intent_3= new Intent(peninsula_bandarban.this,select_car.class);
    ...
    public void cheackRoom(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(peninsula_bandarban.this).create();
