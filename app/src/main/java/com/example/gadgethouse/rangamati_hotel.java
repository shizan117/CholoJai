...
public class rangamati_hotel extends AppCompatActivity {
    private LinearLayout checkInDate,checkOutDate,needsLayout,princeLayout,greenLayout,motiLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rangamati_hotel);

        email = getIntent().getStringExtra("email");
        numberOfSpot = getIntent().getIntExtra("numberOfSpot",0);
        location = getIntent().getStringExtra("location");

        needsLayout = (LinearLayout) findViewById(R.id.needsLayout);
        needsLayout.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(rangamati_hotel.this,needs_rangamati.class);
        ...
        princeLayout = (LinearLayout) findViewById(R.id.princeLayout);
        princeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(rangamati_hotel.this,prince_rangamati.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(rangamati_hotel.this,green_rangamati.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        motiLayout = (LinearLayout) findViewById(R.id.motiLayout);
        motiLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(rangamati_hotel.this,moti_rangamati.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        showLocation3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Hotel Green Castle");
            }
        });
    ...
    public void fillUpTheDate(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(rangamati_hotel.this).create();
    ...
    private void showLocation(String sDestination) {
        String sSource = "Rangamati bus stand";
        try{
