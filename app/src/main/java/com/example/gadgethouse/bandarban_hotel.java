...
public class bandarban_hotel extends AppCompatActivity {
    private LinearLayout checkInDate,checkOutDate,peninsulaLayout,well_parkLayout,royalLayout,diamondLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bandarban_hotel);

        email = getIntent().getStringExtra("email");
        numberOfSpot = getIntent().getIntExtra("numberOfSpot",0);
        location = getIntent().getStringExtra("location");

        peninsulaLayout = (LinearLayout) findViewById(R.id.peninsulaLayout);
        peninsulaLayout.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(bandarban_hotel.this,peninsula_bandarban.class);
        ...
        well_parkLayout = (LinearLayout) findViewById(R.id.well_parkLayout);
        well_parkLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(bandarban_hotel.this,well_park_bandarban.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        royalLayout = (LinearLayout) findViewById(R.id.royalLayout);
        royalLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numOfPerson =  Integer.parseInt(showPerson.getText().toString());
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(bandarban_hotel.this,royal_bandarban.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        diamondLayout = (LinearLayout) findViewById(R.id.diamondLayout);
                ...
                if(viewCheakInDate.getText().toString() == "" || viewCheakOutDate.getText().toString() == ""){
                    ...
                    if(numOfPerson>100){
                        ...
                        if(numOfDays<1){
                            ...
                            Intent intent_1= new Intent(bandarban_hotel.this,diamond_bandarban.class);
                            intent_1.putExtra("numberOfSpot",numberOfSpot);
                            intent_1.putExtra("location",location);
                            intent_1.putExtra("numberOfPerson",numOfPerson);
                            intent_1.putExtra("numberOfDays",numOfDays);
        ...
        showLocation1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Hill Palace Resort");
            }
        });
        ...
        showLocation4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLocation("Hotel Diamond Park");
            }
        });
    }
    public void fillUpTheDate(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(bandarban_hotel.this).create();
    ...
    private void showLocation(String sDestination) {
        String sSource = "Bandarban Bus Stop";
        try{
