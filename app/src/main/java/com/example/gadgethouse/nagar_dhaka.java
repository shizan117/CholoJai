...
public class nagar_dhaka extends AppCompatActivity {
    private Button ok1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagar_dhaka);
            ...
            public void onClick(View v) {
                if(((!checkBox1.isChecked()  && Integer.parseInt(textView1.getText().toString())>0)) || ((!checkBox2.isChecked()  && Integer.parseInt(textView2.getText().toString())>0)) || ((!checkBox3.isChecked()  && Integer.parseInt(textView3.getText().toString())>0)) || ((!checkBox4.isChecked()  && Integer.parseInt(textView4.getText().toString())>0))){
                    ...
                    if(checkBox1.isChecked()){
                        int singleBedRent =1945 * (Integer.parseInt(textView1.getText().toString()));
                        hotelCost=hotelCost+singleBedRent;
                    }
                    if(checkBox2.isChecked()){
                        int doubleBedRent =2702 * (Integer.parseInt(textView2.getText().toString()));
                        hotelCost=hotelCost+doubleBedRent;
                    }
                    if(checkBox3.isChecked()){
                        int twinRoomRent =2810 * (Integer.parseInt(textView3.getText().toString()));
                        hotelCost=hotelCost+twinRoomRent;
                    }
                    if(checkBox4.isChecked()){
                        int presidentialRent =3200 * (Integer.parseInt(textView4.getText().toString()));
                        hotelCost=hotelCost+presidentialRent;
                    }

                    Intent intent_3= new Intent(nagar_dhaka.this,select_car.class);
    ...
    public void cheackRoom(int num){
        AlertDialog alertDialog = new AlertDialog.Builder(nagar_dhaka.this).create();
